...
# This script will open a window and place the camera stream
# from each camera in a window arranged horizontally.
...
class Stereo_Camera():
    ...
    def loadCalibConfigs(self, extrinsics_path='config/extrinsics.yml',
        ...
        return extrinsics_config.getNode("R").mat(),\
               extrinsics_config.getNode("T").mat(),\
               extrinsics_config.getNode("R1").mat(),\
               extrinsics_config.getNode("R2").mat(),\
               extrinsics_config.getNode("P1").mat(),\
               extrinsics_config.getNode("P2").mat(),\
               extrinsics_config.getNode("Q").mat(),\
               intrinsics_config.getNode("M1").mat(),\
               intrinsics_config.getNode("D1").mat(),\
               intrinsics_config.getNode("M2").mat(),\
               intrinsics_config.getNode("D2").mat()

    def calibCameras(self, left_image, right_image):
        R, T, R1, R2, P1, P2, \
        Q, M1, D1, M2, D2 = self.loadCalibConfigs('config/extrinsics.yml',
